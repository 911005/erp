<template >
  <div>
    ...
    <vxe-button status="primary" content="查询" @click="findMcustomerByName()"></vxe-button>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<!--新增窗口-->
    ...
    <vxe-modal v-model="demo.addStatus" :title=" '新增'" width="800" min-width="600" min-height="300"  resize destroy-on-close>
      <vxe-form :data="demo.addData" title-align="right" title-width="100" >
        <vxe-form-item title="原材料客户" title-align="left" :title-width="200" :span="24" :title-prefix="{icon: 'vxe-icon-comment'}"></vxe-form-item>
...
export default {
  ...
  setup(){
    ...
    const findMcustomerByName = async () =>{
      const res = await request.get('/mcustomer/findMcustomerByName/'+demo.searchInput1);
      console.log(res)
      demo.ma = res.data
      console.log(demo.ma)
      return res
