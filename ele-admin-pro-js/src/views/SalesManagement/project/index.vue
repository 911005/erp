...
<!--        </vxe-form-item>-->
<!--        &lt;!&ndash;        下拉框&ndash;&gt;-->
<!--        &lt;!&ndash;        <vxe-form-item type="select" label="客户名称" title="客户名称2" prop="projectName">&ndash;&gt;-->
<!--        &lt;!&ndash;          <vxe-select v-model="pro.projectName">&ndash;&gt;-->
<!--        &lt;!&ndash;            <vxe-option v-for="item in pro.projects" :key="item.projectname" :value="item.projectname" :label="item.projectname">&ndash;&gt;-->
<!--        &lt;!&ndash;              {{ item.projectname }}&ndash;&gt;-->
<!--        &lt;!&ndash;            </vxe-option>&ndash;&gt;-->
<!--        &lt;!&ndash;          </vxe-select>&ndash;&gt;-->
<!--        &lt;!&ndash;        </vxe-form-item>&ndash;&gt;-->
