<template>
  <div>
    <vxe-button status="primary" content="查询" @click="findStudents()"></vxe-button>
    <vxe-button status="primary" content="新增" @click="addStudent()"></vxe-button>
    <vxe-table
      :data="demo.students">
      <vxe-column type="seq" width="60" field="id"></vxe-column>
      <vxe-column field="studentid" title="学号"></vxe-column>
      <vxe-column field="name" title="姓名"></vxe-column>
      <vxe-column field="sex" title="性别"></vxe-column>
      <vxe-column field="grade" title="年级"></vxe-column>
      <vxe-column field="major" title="专业"></vxe-column>
    ...
    <vxe-modal v-model="demo.status" :title=" '新增&保存'" width="800" min-width="600" min-height="300"  resize destroy-on-close>
      <vxe-form :data="demo.updateData" title-align="right" title-width="100" >
        ...
        <vxe-form-item field="sex" title="性别" :span="12" :item-render="{}">
          <template #default="{ data }">
            <vxe-input v-model="data.sex" placeholder="请输入性别"></vxe-input>
          </template>
        </vxe-form-item>
        <vxe-form-item field="grade" title="年级" :span="12" :item-render="{}">
        <template #default="{ data }">
          <vxe-input v-model="data.grade" placeholder="请输入年级"></vxe-input>
        </template>
      </vxe-form-item>
        <vxe-form-item field="phone" title="联系方式" :span="12" :item-render="{}">
          <template #default="{ data }">
            <vxe-input v-model="data.grade" placeholder="请输入联系方式"></vxe-input>
          </template>
        </vxe-form-item>
    ...
    <vxe-modal v-model="demo.addStatus" :title=" '新增&保存'" width="800" min-width="600" min-height="300"  resize destroy-on-close>
      <vxe-form :data="demo.addData" title-align="right" title-width="100" >
        ...
        <vxe-form-item field="phone" title="联系方式" :span="12" :item-render="{}">
          <template #default="{ data }">
            <vxe-input v-model="data.phone" placeholder="请输入联系方式"></vxe-input>
          </template>
        </vxe-form-item>
