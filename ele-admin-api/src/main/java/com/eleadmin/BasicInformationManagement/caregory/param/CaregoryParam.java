package com.eleadmin.BasicInformationManagement.caregory.param;
...
@ApiModel(value = "CaregoryParam对象", description = "查询参数")
public class CaregoryParam extends BaseParam {
    private static final long serialVersionUID = 1L;

    @QueryField(type = QueryType.EQ)
    private Integer id;

    private String fircaregory;
