...
public class ProjectServiceImpl extends ServiceImpl<ProjectMapper, Project> implements ProjectService {
    ...
    @Override
    public List<Project> findProjectsBycustomerName(String name) {
        return projectMapper.findProjectsBycustomerName(name);
    }

    @Override
    public List<Project> findProjectsByprojectName(String pname) {
        return projectMapper.findProjectsByprojectName(pname);
    }
