...
public class CodeGenerator {
    ...
    private static final String DB_PASSWORD = "ctt123";
    // 包名
    private static final String PACKAGE_NAME = "com.eleadmin.RawMaterialManagement";
    // 模块名
    private static final String MODULE_NAME = "concreteuser";
    // 需要生成的表
